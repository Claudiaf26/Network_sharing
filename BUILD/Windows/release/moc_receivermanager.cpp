...
#include "../../Network_sharing/Managers/receivermanager.h"
...
struct qt_meta_stringdata_ReceiverManager_t {
    QByteArrayData data[4];
    char stringdata0[36];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ReceiverManager_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ReceiverManager_t qt_meta_stringdata_ReceiverManager = {
    {
QT_MOC_LITERAL(0, 0, 15), // "ReceiverManager"
QT_MOC_LITERAL(1, 16, 4), // "loop"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 13) // "checkProgress"

    },
    "ReceiverManager\0loop\0\0checkProgress"
};
...
const QMetaObject ReceiverManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ReceiverManager.data,
      qt_meta_data_ReceiverManager,  qt_static_metacall, nullptr, nullptr}
};
...
void *ReceiverManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ReceiverManager.stringdata0))
