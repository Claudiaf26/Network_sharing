...
#include "../../Network_sharing/Managers/notificationmanager.h"
...
QT_MOC_LITERAL(3, 38, 18) // "removeNotification"

    },
    "NotificationManager\0showNotification\0"
    "\0removeNotification"
};
...
void NotificationManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->showNotification((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->removeNotification(); break;
        default: ;
        }
    }
}
...
const QMetaObject NotificationManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_NotificationManager.data,
      qt_meta_data_NotificationManager,  qt_static_metacall, nullptr, nullptr}
};
