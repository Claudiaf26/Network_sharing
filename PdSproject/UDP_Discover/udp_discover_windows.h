#ifdef _WIN32
#ifndef UDP_DISCOVER_WINDOWS_H
#define UDP_DISCOVER_WINDOWS_H
...
#include <Iphlpapi.h>
#include <memory>
#include "UDP_Discover/udp_discover_interface.h"
...
public:
    ...
    void run(int8_t mode, string newUserName);
    ...
    UDP_Discover_Windows(string userName);
    ~UDP_Discover_Windows();

};
#endif // UDP_DISCOVER_WINDOWS_H
#endif
