...
UDP_Discover_Windows::UDP_Discover_Windows(string userN) : UDP_Discover_Interface(){
    mode = UDS_STOP;
    userName = userN;
    char loopch = 0;
...
void UDP_Discover_Windows::run(int8_t  initialMode, string newUserName) {
    if (initialMode == UDS_STOP || mode != UDS_STOP)
        return;
